...
const portrait = '/nanditha.jpgi alre'
...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="contact" className="contact section-pad section-rule"><div className="section-label">04 / Contact</div><div className="contact-layout"><div><h2>Let&apos;s start a<br /><em>conversation.</em></h2><p>Have a question, an opportunity, or simply want to say hello? I&apos;d love to hear from you.</p><div className="social-links"><a href="mailto:nandithannair2007@gmail.com"><Mail size={17} /> Email <ArrowUpRight size={14} /></a><a href="https://github.com/nanditha-07" target="_blank" rel="noreferrer"><GitBranch size={17} /> GitHub </a><a href="https://www.linkedin.com/in/nanditha-nair-b315a8393/" target="_blank" rel="noreferrer"><Network size={17} /> LinkedIn </a></div></div><form className="contact-form" onSubmit={handleSubmit}><label>Name<input required name="name" placeholder="Your name" /></label><label>Email<input required type="email" name="email" placeholder="you@example.com" /></label><label>Message<textarea required name="message" rows={4} placeholder="Tell me a little about your message..." /></label><button className="button button-primary" type="submit">{sent ? <><Check size={17} /> Message ready</> : <>Send message <ArrowUpRight size={17} /></>}</button>{sent && <p className="form-success">Thanks — your message has been received.</p>}</form></div></section>
